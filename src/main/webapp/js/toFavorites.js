...
/*提交添加网站，单击确定获取按回车都能提交-------------------------------end*/


/*下拉框提示、请求后台，返回数据给页面智能提示-------------------------------------------start*/
$(function () {
...
/*下拉框提示、请求后台，返回数据给页面智能提示-------------------------------------------end*/


/*搜索数据，按回车和单击搜索都行-----------------------------------start*/
...
/*当页面加载，就定位光标到输入框中，点击取消按钮时刷新页面----start*/
$(function () {
    $("#condition").focus();
...
/*当页面加载，就定位光标到输入框中，点击取消按钮时刷新页面----end*/
